...
module.exports = yeoman.generators.Base.extend({
  ...
  projectFiles: function () {
    ...
    this.fs.copy(
     ...
     //NAV BAR
     var navPath = this.destinationPath('app/index.html');
     var navFile = this.readFileAsString(navPath);
     var navLink = '\n <li data-ng-class="{active: $state.includes(\'translation\')}"><a ui-sref="translation">Translation</a></li>';
     var navTag = '</li>';
     if (navFile.indexOf (navLink) === -1) {
         var pos = navFile.lastIndexOf (navTag) + navTag.length;
         var output = [navFile.slice(0, pos), navLink, navFile.slice(pos)].join('');
         this.write(navPath, output);
     }
